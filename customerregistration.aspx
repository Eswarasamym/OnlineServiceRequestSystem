             ...
             <tr>
                ...
                <td style="width: 100px; height: 28px">
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBox3"
                        ErrorMessage="Enter Company Name Correctly" ValidationExpression='\w+[a-zA-Z\s]+$'
                        Width="240px"></asp:RegularExpressionValidator><br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox3"
                        ErrorMessage="Enter company name" Width="169px"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
